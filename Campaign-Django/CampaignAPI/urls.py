...
urlpatterns = [
    ...
    path('campaigncore/<int:cid>/campaignusers/<int:user>/', CampaignUsers_Info, name="CampaignUsersInfo"),
    ...
    path('campaigncore/<int:cid>/consumable-items/',ConsumItems_List, name='ConsumeItems'),
