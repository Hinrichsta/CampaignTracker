    ...
    return (
        <div className="flex h-full mx-10">
            ...
            <div className="flex-row w-full">
                ...
                <div className="h-4/6 my-20 bg-slate-500 text-white border-black border-4 rounded-xl shadow-xl text-center">
                    <h3 className="text-2xl">Items</h3>
                </div>
            </div>
            <div className="flex-row w-full mx-10">
                <div className="h-96 my-12 bg-slate-500 text-white border-black border-4 rounded-xl shadow-xl text-center">
                    <h3 className="text-2xl pb-8">Quick Add</h3>
                    <QuickAdd />
                </div>
                <div className="h-1/2 my-20 bg-slate-500 text-white border-black border-4 rounded-xl shadow-xl text-center">
